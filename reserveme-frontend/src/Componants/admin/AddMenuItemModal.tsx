...
import {
  createMenuItem,
  updateMenuItem,
} from "../management/MenuItemManagement";
...
export const AddEditMenuItemModal = ({
  ...
  const mutation = useMutation({
    mutationFn: (variables: { menuId: number; formData: MenuItemForm }) =>
      createMenuItem(variables.menuId, variables.formData),
    onSuccess: (data) => {
      // Appeler la fonction de mise à jour de la liste des réservations
      updateMenuItemList();
      // Fermez le modal (si nécessaire)

      showAlert("Ajout  bien enregistrée !", "success");
      onClose();
